  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-1 justify-end">
        <button
          type="button"
          className={cn(btnBase, 'relative', activePanel === 'mention' && btnActive)}
        ...
        <button type="button" className={cn(btnBase, activePanel === 'bookmark' && btnActive)} onClick={() => togglePanel('bookmark')} title="북마크">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2z" />
          </svg>
        </button>

        <button type="button" className={cn(btnBase, activePanel === 'friends' && btnActive)} onClick={() => togglePanel('friends')} title="멤버">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button type="button" className={cn(btnBase, 'relative', activePanel === 'settings' && btnActive)} onClick={() => togglePanel('settings')} title="설정">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
